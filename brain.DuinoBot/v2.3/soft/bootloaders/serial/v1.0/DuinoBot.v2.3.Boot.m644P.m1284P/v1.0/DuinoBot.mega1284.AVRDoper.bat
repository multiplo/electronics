...
.\avrdude -C .\avrdude.conf -p atmega1284p -c stk500v2 -P avrdoper -V -U flash:w:".\optiboot_DB23_1284p.hex":i

rem Lockbits:
.\avrdude -C .\avrdude.conf -p atmega1284p -c stk500v2 -P avrdoper -U lock:w:0xEF:m
